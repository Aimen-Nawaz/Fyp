# ui_qt_ocr_theme_no_errors.py — PySide6 (Qt) OCR-style UI (No TensorFlow)
# Changes:
...
#
# Deps: PySide6 pandas numpy rapidfuzz jellyfish Unidecode
import os
import sys
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.lbl_subtitle = QLabel("Fix misspelled or partial medicine names using blended fuzzy + phonetic matching.")
    ...
    def _about(self):
        QMessageBox.information(
            ...
            "TensorFlow-free fuzzy + phonetic matcher\n"
    ...
    def on_predict(self):
        ...
        # Predicted medicine ko red underline + red color ke sath dikhayen
        safe_pred = (
            str(pred)
            .replace("&", "&amp;")
            .replace("<", "&lt;")
